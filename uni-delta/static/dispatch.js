...
// HTML templates
_vbox_html = '<div class="fuzz" id="vbox_{g_vboxlevel}"><table align="center" class="vbox-table"><tr><td class="vbox-cell"><div class="vbox container-fluid"><div class="vbox-content">{content}</div><a href="#" class="vbox-close"><i class="fa fa-times"></i></a></div></td></tr></table></div>';

_loading_circle_html = '<div id="loading-circle"><i class="fa-solid fa-gear fa-spin"></i><div class="loading-circle-message-wrapper"><div class="loading-circle-message">Loading...</div></div></div>';
